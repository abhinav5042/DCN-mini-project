...
INSERT INTO `receivers` (`id`, `rname`, `remail`, `rpassword`, `rphone`, `rbg`, `rcity`) 
VALUES  
...
--  
ALTER TABLE `blooddinfo`  
  ADD CONSTRAINT `blooddinfo_ibfk_2` FOREIGN KEY (`rid`) REFERENCES 
`receivers` (`id`);  
...
--  
ALTER TABLE `bloodinfo`  
  ADD CONSTRAINT `bloodinfo_ibfk_1` FOREIGN KEY (`hid`) REFERENCES 
`hospitals`  (`id`);  
COMMIT;  
